...
//-40009 :  base64加密异常
//-40010 :  base64解密异常
namespace Hmj.ExtendAPI.WeiXin.Lib
{
    public class WXBizMsgCrypt
    {
        ...
        public WXBizMsgCrypt()
        {
            ...
            m_sToken = AppConfig.Get("WXCorpToken");
            m_sCorpID = AppConfig.Get("WXCorpID");
            m_sEncodingAESKey = AppConfig.Get("WXCorpEncodingAESKey");
        }
        //构造函数
