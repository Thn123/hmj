(function () {
    ...
    var GenerateCss = function () {
        ...
        $("#mb_tit").css({
            display: 'block', fontSize: '15px', color: '#444', padding: '10px 15px', lineHeight: '20px',
            backgroundColor: '#DDD', borderRadius: '15px 15px 0 0',
            borderBottom: '3px solid #8F66BD', fontWeight: 'bold'
        });
        ...
        $("#mb_btn_ok,#mb_btn_no").css({ width: '55px', height: '23px', color: 'white', border: 'none', fontSize: '15px', padding: '5px' });
        $("#mb_btn_ok").css({ backgroundColor: '#8F66BD', fontSize: '15px' });
