<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Discount.aspx.cs" Inherits="Hmj.WebApp.wechat.NewMember.Discount" %>
...
<div class="quan_list">
   <ul style="display:block;" runat="server" id="quan1">
      
     
   </ul>
   
   <ul runat="server" id="quan2">
   
     
   </ul>

    <ul style="display:none;" runat="server" id="quan3">
...
<script type="text/javascript">
    $('.quanTab ol').on('click', function () {
        $(this).addClass('cur').siblings().removeClass('cur');
        $('.quan_list ul').eq($(this).index()).show().siblings().hide();
    })
</script>
