<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="daohang.aspx.cs" Inherits="Hmj.WebApp.wechat.Store.daohang" %>
...
<body>
    <form id="form1" runat="server">
        <div class="daohang">
            ...
            <p>选择城市及柜台，查询你所需的柜台。</p>
            <div class="carbtn" style="margin-bottom: 0; padding-bottom: 0;">
                <ol style="text-align: left;">
                    <h5>店铺类型</h5>
                    <div class="daohangli selecticon">
                        <asp:DropDownList ID="DropDownList4" runat="server" class="dropdown-select" onchange="show4();">
