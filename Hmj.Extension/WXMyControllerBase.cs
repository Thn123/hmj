...
namespace Hmj.Extension
{
    ...
    public class WXMyControllerBase : BaseController
    {
        /// <summary>
        /// 获取当前登录用户标识
        /// </summary>
        ...
        protected virtual USER_INFO_EX CurrentLoginUser
        {
            get
            {
                return WXMyContext.CurrentLoginUser;
            }
        }
        ...
        protected virtual int CurrentLoginUserId
        {
            get
            {
                return CurrentLoginUser == null ? 0 : WXMyContext.CurrentLoginUser.ID;
            }
        }
        ...
        protected virtual int CurrentUserOrgId
        {
            get
            {
                ...
                return CurrentLoginUser == null || CurrentLoginUser.ORG_ID == 0 ? -1 : WXMyContext.CurrentLoginUser.ORG_ID;
            }
        }
        ...
        protected virtual int? CurrentUserMerchantsID
        {
            get
            {
                if (CurrentLoginUser != null)
                {
                    return WXMyContext.CurrentLoginUser.ORG_ID;
                }
                return null;
            }
        }
        ...
        protected virtual int CurrentUserStoreId
        {
            get
            {
                ...
                return CurrentLoginUser == null || CurrentLoginUser.STORE_ID == 0 ? -1 : WXMyContext.CurrentLoginUser.STORE_ID;
            }
            set
            {
                if (CurrentLoginUser != null)
        ...
        protected virtual string CurrentUserDataStores
        {
            get
            {
                return CurrentLoginUser == null ? "" : WXMyContext.CurrentLoginUser.USER_STORES_OBJ;
            }
        }
        /// <summary>
        ...
        /// 当前登录用户所属商户信息
        /// </summary>
        protected virtual ORG_INFO CurrentMerchants
        {
            get { return WXMyContext.CurrentMerchants; }
        }
